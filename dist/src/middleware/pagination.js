 ...
 */
export function odataPagination(options = {}) {
 ...
 */
async function applyPagination(data, context, options, request) {
    ...
    if (data && typeof data === 'object') {
        return await addCountToEntity(data, queryOptions, options, context);
    }
 ...
 */
async function paginateCollection(entities, queryOptions, options, context, request) {
 ...
 */
async function addCountToEntity(entity, queryOptions, options, context) {
    const result = { ...entity };
 ...
 */
function validateTopLimit(top, options) {
    if (top === undefined) {
 ...
 */
function generateNextLink(context, request, top, skip) {
