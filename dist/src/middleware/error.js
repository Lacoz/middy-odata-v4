 ...
 */
export function odataError(options = {}) {
 ...
 */
export function createODataErrorFromType(errorType, message, details) {
    const errorMap = {
 ...
 */
export function validateODataQuery(options, context) {
    const errors = [];
    // Validate $top
