 ...
 */
export function odataMetadata(options = {}) {
 ...
 */
export function createAnnotation(target, term, value, qualifier) {
    return {
        target,
        term,
        value,
...
export const commonAnnotations = {
    ...
    entitySetCapabilities: (entitySetName) => ({
    ...
    propertyDisplayName: (entityTypeName, propertyName, displayName) => ({
        [`${entityTypeName}/${propertyName}#Org.OData.Core.V1.DisplayName`]: displayName,
    }),
    propertyDescription: (entityTypeName, propertyName, description) => ({
        [`${entityTypeName}/${propertyName}#Org.OData.Core.V1.Description`]: description,
    }),
    // Navigation property annotations
    navigationPropertyRestrictions: (entityTypeName, navPropertyName) => ({
    ...
    functionCapabilities: (functionName) => ({
        [`${functionName}#Org.OData.Capabilities.V1.Callable`]: true,
    }),
    actionCapabilities: (actionName) => ({
 ...
 */
export function mergeAnnotations(...annotationObjects) {
 ...
 */
export function createMetadataOptions(baseOptions = {}, customAnnotations = {}) {
    return {
